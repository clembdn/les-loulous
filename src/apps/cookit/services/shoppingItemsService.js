...
function normalize(raw) {
  return {
    ...
    // Lien vers la bibliotheque d'aliments : permet d'afficher les valeurs
    // nutritionnelles d'un article et de le journaliser en un tap.
...
export function subscribeToItems(callback, onError) {
  ...
  return onSnapshot(q, (snap) => {
    ...
    console.error('[Cook’It] items error:', err)
    onError?.(err)
  })
}
