...
import { Plus, Star, Apple } from 'lucide-react'
...
export default function QuickAddBar({ catalog, items, onAdd, onPickFood }) {
  ...
  return (
    <div>
      <form onSubmit={submit} className="flex gap-2">
        ...
        />
        {/* Deuxieme porte d'entree : piocher dans les aliments deja scannes plutot
            que de retaper un nom. Le lien nutritionnel suit automatiquement. */}
        {onPickFood && (
          <Button type="button" variant="secondary" size="icon" className="h-11 w-11 shrink-0" onClick={onPickFood} aria-label="Choisir un aliment scanné">
            <Apple size={18} />
          </Button>
        )}
